...
# |    семейство    |   размера памяти  | описание                          |
# |=================|===================|===================================|
# | STM32F10X_LD    | 16 - 32 Kbytes    | Low density devices               |
# | STM32F10X_LD_VL | 16 - 32 Kbytes    | Low density Value Line devices    |
# | STM32F10X_MD    | 64 - 128 Kbytes   | Medium density devices            |
# | STM32F10X_MD_VL | 64 - 128 Kbytes   | Medium density Value Line devices |
# | STM32F10X_HD    | 256 - 512 Kbytes  | High density devices              |
# | STM32F10X_HD_VL | 256 - 512 Kbytes  | High density value line devices   |
# | STM32F10X_XL    | 512 - 1024 Kbytes | XL-density devices                |
...
JLINK_PARAMS_LOAD =  -device STM32F103C8 
